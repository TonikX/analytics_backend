...
urlpatterns = [
    ...
    path(
        "api/record/tools/counter_type",
        views.WorkProgramEvaluationToolsCounter.as_view(),
    ),
    ...
    path(
        "api/record/workprogram/editors_wp/<int:pk>", views.GetAllWPsByEditor.as_view()
    ),
    path(
        "api/record/workprogram/empty_field_wp", views.GetAllWPsWithEmptyField.as_view()
    ),
    path(
    ...
    path(
        "api/record/workprogram/get_wp_by_year",
        views.WorkProgramRealisedInYear.as_view(),
    ),
