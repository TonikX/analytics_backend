...
urlpatterns = [
    ...
    path('api/domain/', views.DomainListCreateAPIView.as_view(), name='domains'),
    path('api/domain/<int:pk>', views.DomainDetailAPIView.as_view(), name='domain_detail'),
    
    path('api/item/', views.ItemsListCreateAPIView.as_view(), name='item'),
    path('api/item/<int:domain_id>', views.ItemsListAPIView.as_view(), name='itembydomain'),
    path('api/item/detail/<int:pk>', views.ItemDetailAPIView.as_view(), name='item_detail'),
