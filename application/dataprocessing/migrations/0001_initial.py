# Generated by Django 2.2.6 on 2020-09-27 15:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=900, verbose_name='Название')),
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Автор', to=settings.AUTH_USER_MODEL, verbose_name='Пользователи')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item2', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, related_name='item2', to='dataprocessing.Items', verbose_name='Элемент РПД')),
            ],
        ),
        migrations.AddField(
            model_name='items',
