# Generated by Django 2.2.6 on 2020-04-25 20:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('relation', models.CharField(choices=[('0', 'неопределенное'), ('1', 'включает в себя'), ('3', 'является пререквизитом для'), ('4', 'имеет пререквизит'), ('5', 'тождество'), ('6', 'относится к'), ('7', 'отсутствует')], default='1', max_length=10, verbose_name='Связь')),
