...
from .educational_program.pk_comptencies.models import GroupOfPkCompetencesInGeneralCharacteristic, PkCompetencesInGroupOfGeneralCharacteristic, IndicatorInPkCompetenceInGeneralCharacteristic
from .educational_program.over_professional_competencies.models import GroupOfOverProfCompetencesInGeneralCharacteristic, OverProfCompetencesInGroupOfGeneralCharacteristic, IndicatorInPkCompetenceInGeneralCharacteristic
from .educational_program.key_competences.models import GroupOfKeyCompetencesInGeneralCharacteristic, KeyCompetencesInGroupOfGeneralCharacteristic, IndicatorInPkCompetencesInGeneralCharacteristic
from .educational_program.general_prof_competencies.models import GroupOfGeneralProfCompetencesInGeneralCharacteristic, GeneralProfCompetencesInGroupOfGeneralCharacteristic, IndicatorInPkCompetenceInGeneralCharacteristic
