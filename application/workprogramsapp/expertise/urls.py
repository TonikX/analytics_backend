...
from workprogramsapp.expertise.views import (
    ChangeStatusesOfExpertiseWP,
...
urlpatterns = [
    ...
    path(
        "api/expertise/log_accept/<int:pk>",
        ExpertiseChangeLogListView.as_view(),
        name="expertise_log_pk",
    ),
    path(
        "api/expertise/log_accept",
        ExpertiseChangeLogListView.as_view(),
        name="expertise_log",
    ),
]
