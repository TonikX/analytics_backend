...
class GroupOfOverProfCompetencesInGeneralCharacteristic(models.Model):
    ...
    general_characteristic = models.ForeignKey('GeneralCharacteristics', on_delete=models.CASCADE, verbose_name="Общая характеристика", related_name = "group_of_over_prof_competences")
...
class OverProfCompetencesInGroupOfGeneralCharacteristic(models.Model):
    ...
    group_of_pk = models.ForeignKey('GroupOfOverProfCompetencesInGeneralCharacteristic', on_delete=models.CASCADE,
                                    verbose_name="Группа над-профессиональных компетенций в ОХ", related_name = "competence_in_group_of_over_prof_competences")
...
class IndicatorInOverProfCompetenceInGeneralCharacteristic(models.Model):
    ...
    competence_in_group_of_pk = models.ForeignKey('OverProfCompetencesInGroupOfGeneralCharacteristic', on_delete=models.CASCADE, verbose_name="Группа над-профессиональных компетенций в ОХ",
