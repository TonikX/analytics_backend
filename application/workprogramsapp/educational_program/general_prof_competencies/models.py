...
class GroupOfGeneralProfCompetencesInGeneralCharacteristic(models.Model):
    ...
    general_characteristic = models.ForeignKey('GeneralCharacteristics', on_delete=models.CASCADE, verbose_name="Общая характеристика", related_name = "group_of_general_prof_competences")
...
class GeneralProfCompetencesInGroupOfGeneralCharacteristic(models.Model):
    ...
    group_of_pk = models.ForeignKey('GroupOfGeneralProfCompetencesInGeneralCharacteristic', on_delete=models.CASCADE,
                                    verbose_name="Группа общепрофессиональных компетенций в ОХ", related_name = "competence_in_group_of_general_prof_competences")
...
class IndicatorInGeneralProfCompetenceInGeneralCharacteristic(models.Model):
    ...
    competence_in_group_of_pk = models.ForeignKey('GeneralProfCompetencesInGroupOfGeneralCharacteristic', on_delete=models.CASCADE, verbose_name="Группа общепрофессиональных компетенций в ОХ",
