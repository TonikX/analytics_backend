...
class WorkProgram(CloneMixin, models.Model):
    ...
    approval_date = models.DateTimeField(
        editable=True, auto_now_add=True, blank=True, null=True
    )
    ...
    prerequisites = models.ManyToManyField(
        Items, related_name="WorkProgramPrerequisites"
    )
    ...
    prerequisites = models.ManyToManyField(
        Items,
        related_name="WorkProgramPrerequisites",
    ...
    outcomes = models.ManyToManyField(
        Items,
        related_name="WorkProgramOutcomes",
        through="OutcomesOfWorkProgram",
        verbose_name="Постреквизиты",
    )
    title = models.CharField(max_length=1024, verbose_name="Название")
    hoursFirstSemester = models.IntegerField(
        blank=True, null=True, verbose_name="Количество часов в 1 семестре"
    )
    hoursSecondSemester = models.IntegerField(
        blank=True, null=True, verbose_name="Количество часов в 2 семестре"
    )
    ...
    work_status = models.CharField(
        max_length=1, choices=status_choise, verbose_name="Архив", default="w"
    )
    hours = models.IntegerField(
        blank=True, null=True, verbose_name="Сумма часов по разделам"
    )
    extra_points = models.CharField(
        choices=extra_points_choise,
        max_length=1,
        verbose_name="Квалификация",
        blank=True,
        null=True,
    ...
    language = models.CharField(
        choices=languages_for_wp,
        max_length=15,
        verbose_name="Языки",
        blank=True,
        null=True,
    )
    have_course_project = models.BooleanField(
        blank=True, null=True, verbose_name="Имеет ли РПД курсовой проект"
    )
    have_diff_pass = models.BooleanField(
        blank=True, null=True, verbose_name="Имеет ли РПД дифф. зачет"
    )
    have_pass = models.BooleanField(
        blank=True, null=True, verbose_name="Имеет ли РПД зачет"
    )
    have_exam = models.BooleanField(
        blank=True, null=True, verbose_name="Имеет ли РПД экзамен"
    )
    lecture_hours = models.CharField(
        max_length=1024, null=True, blank=True, verbose_name="Часы лекций"
    )
    practice_hours = models.CharField(
        max_length=1024, null=True, blank=True, verbose_name="Часы Практик"
    )
    lab_hours = models.CharField(
        max_length=1024, null=True, blank=True, verbose_name="Часы лабораторных работ"
    )
    srs_hours = models.CharField(
        max_length=1024, null=True, blank=True, verbose_name="Часы СРС"
    )
    ...
    structural_unit = models.ForeignKey(
        ...
        related_name="workprogram_in_structural_unit",
        blank=True,
        null=True,
    )
    bars = models.BooleanField(
        default=False, verbose_name="Нужно отослать дисциплину в БАРС"
    )
    lecture_hours_v2 = models.CharField(
        max_length=1024, null=True, blank=True, verbose_name="Часы лекций"
    )
    practice_hours_v2 = models.CharField(
        max_length=1024, null=True, blank=True, verbose_name="Часы Практик"
    )
    lab_hours_v2 = models.CharField(
        max_length=1024, null=True, blank=True, verbose_name="Часы лабораторных работ"
    )
    srs_hours_v2 = models.CharField(
        max_length=1024, null=True, blank=True, verbose_name="Часы СРС"
    )
    contact_hours_v2 = models.CharField(
        max_length=1024, null=True, blank=True, verbose_name="Часы Контактной работы"
    )
    consultation_v2 = models.CharField(
        max_length=1024, null=True, blank=True, verbose_name="Консультации"
    )
    number_of_semesters = models.IntegerField(
        blank=True, null=True, verbose_name="Количество семестров в дисциплине"
    )
    ze_v_sem = models.CharField(
        max_length=1024,
        blank=True,
        null=True,
        verbose_name="Количество зачетных единиц у РПД",
    )
    read_notifications = models.CharField(
        max_length=256,
    ...
    implementation_format = models.CharField(
        choices=implementation_format_choise,
        max_length=15,
    ...
    moodle_link = models.URLField(
        max_length=1024, null=True, blank=True, verbose_name="Ссылка на мудл"
    )
    ...
    def clone_programm(programm_id):
        ...
        for eva in EvaluationTool.objects.filter(
            evaluation_tool_of_outcomes__workprogram__id=programm_id
        ).distinct():
            evaluation_disciplines = eva.evaluation_tools.all().filter(
                work_program_id=programm_id
            )
...
class PrerequisitesOfWorkProgram(models.Model):
    ...
    workprogram = models.ForeignKey(
        WorkProgram, on_delete=models.CASCADE, verbose_name="Рабочая программа"
    )
    MasterylevelChoices = [
        ("1", "low"),
        ("2", "average"),
    ...
    masterylevel = models.CharField(
        max_length=1, choices=MasterylevelChoices, default=1, verbose_name="Уровень"
    )
    # def __str__(self):
    #     return self.item
...
class OutcomesOfWorkProgram(CloneMixin, models.Model):
    ...
    evaluation_tool = models.ManyToManyField(
        "EvaluationTool",
        verbose_name="Оценочные средства",
        related_name="evaluation_tool_of_outcomes",
        blank=True,
    )
...
class FieldOfStudy(models.Model):
    ...
    title = models.CharField(
        max_length=1024, verbose_name="Название ОП", blank=True, null=True
    )
    qualification = models.CharField(
        choices=QUALIFICATION_CHOICES,
        max_length=1024,
    ...
    educational_profile = models.CharField(
        max_length=1024, verbose_name="Профиль ОП", blank=True, null=True
    )
    faculty = models.CharField(
        max_length=150, verbose_name="Факультет (Структурное подразделение)", null=True
    )
...
class CourseFieldOfStudy(models.Model):
    ...
    course = models.ForeignKey(
        ...
        blank=False,
        null=False,
        related_name="course_field_of_study",
    )
    field_of_study = models.ForeignKey(
        FieldOfStudy, on_delete=models.CASCADE, verbose_name="Направление подготовки"
    )
...
class AcademicPlan(models.Model):
    ...
    number = models.CharField(
        max_length=1024, verbose_name="- Номер учебного плана", blank=True, null=True
    )
    ...
    author = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        verbose_name="Автор учебного плана",
        on_delete=models.CASCADE,
        related_name="academic_plan_author",
        blank=True,
        null=True,
    )
    ap_isu_id = models.PositiveIntegerField(
        verbose_name="ID учебного плана в ИСУ", blank=True, null=True
    )
    on_check = models.CharField(
        max_length=1024,
        verbose_name="Статус проверки",
        choices=check_status,
        default="in_work",
    )
    excel_generation_errors = models.JSONField(
        blank=True, null=True, verbose_name="Список ошибок в УП"
    )
    ...
    def clone_descipline_blocks(id, siap):
        DisciplineBlocks = DisciplineBlock.objects.filter(
            academic_plan__educational_profile="Экспертный профиль"
        )
        for Block in DisciplineBlocks:
            block_clone = Block.make_clone(
                attrs={"academic_plan_id": siap.data.get("id")}
            )
    ...
    def get_all_changeblocks_from_ap(self, block_to_filter=None):
        ...
        if block_to_filter:
            blocks = DisciplineBlock.objects.filter(
                academic_plan__id=self.id, name__icontains=block_to_filter
            )
        else:
        ...
        for block in blocks:
            for module in DisciplineBlockModule.objects.filter(descipline_block=block):
                changeblock_in_ap = (
                    changeblock_in_ap
                    | DisciplineBlockModule.get_all_changeblocks_from_module(module)
                )
...
class EducationalProgram(models.Model):
    ...
    academic_plan_for_ep = models.ForeignKey(
        "ImplementationAcademicPlan",
        on_delete=models.SET_NULL,
        verbose_name="Учебный план_1",
        related_name="academic_plan_in_educational_program",
        blank=True,
        null=True,
    )
...
class KindsOfActivity(models.Model):
    ...
    name = models.CharField(
        max_length=1024,
        verbose_name="имя сферы проф. деятельности",
        blank=True,
        null=True,
    )
...
class ObjectsOfActivity(models.Model):
    ...
    name = models.CharField(
        max_length=1024,
        verbose_name="имя объекта проф. деятельности",
        blank=True,
        null=True,
    )
...
class EmployerRepresentative(models.Model):
    organization_name = models.CharField(
        max_length=512, verbose_name="Наименование организации", blank=True, null=True
    )
    employer_position = models.CharField(
        max_length=512, verbose_name="Позиция работодателя", blank=True, null=True
    )

    fio_employer = models.CharField(
        max_length=512, verbose_name="ФИО работодателя", blank=True, null=True
    )
    general_characteristic = models.ForeignKey(
...
class GeneralCharacteristics(models.Model):
    ...
    educational_program = models.ManyToManyField(
        "ImplementationAcademicPlan",
        verbose_name="Образовательная программа",
        related_name="general_characteristics_in_educational_program",
        blank=True,
    )
    area_of_activity = models.ManyToManyField(
        "ProfessionalStandard",
        verbose_name="Проф. Стандарт/Область профессиональной деятельности",
        blank=True,
        related_name="area_in_characteristic",
    )
    additional_area_of_activity = models.ManyToManyField(
        "ProfessionalStandard",
        verbose_name="Дополнительные Области профессиональной деятельности",
        blank=True,
        related_name="add_area_in_characteristic",
    )
    objects_of_activity = models.ManyToManyField(
        ObjectsOfActivity,
        verbose_name="Объекты проф. деятельности выпускников",
        blank=True,
    )
    kinds_of_activity = models.ManyToManyField(
        KindsOfActivity,
        verbose_name="Сферы профессиональной деятельности, к которому (которым) готовятся выпускники",
        blank=True,
    )
    tasks_of_activity = models.ForeignKey(
        TasksForEducationalStandard,
        blank=True,
        null=True,
        on_delete=models.SET_NULL,
    ...
    #########################################
    educational_standard = models.ForeignKey(
        EducationalStandard,
        on_delete=models.SET_NULL,
        verbose_name="Образовательный стандарт",
        related_name="educational_standard_in_educational_program",
        blank=True,
        null=True,
    )
    tasks_for_prof_standards = models.ManyToManyField(
        TasksForEducationalStandard,
    ...
    language = models.CharField(
        choices=languages_for_gc,
        max_length=15,
        verbose_name="Языки",
        blank=True,
        null=True,
    )
    is_only_in_university = models.BooleanField(
        blank=True, null=True, verbose_name="Тольков в университете итмо?"
    )
    is_global_educational_program = models.BooleanField(
        blank=True, null=True, verbose_name="Имеет статус международной ОП?"
    )

    is_online_format = models.BooleanField(
        blank=True, null=True, verbose_name="В сетевой форме?"
    )
    collaboration_russian_in_online_format = models.CharField(
        max_length=2048,
        blank=True,
        null=True,
    ...
    is_collaboration_foreign = models.BooleanField(
        blank=True, null=True, verbose_name="В форме совместной ОП?"
    )
    collaboration_foreign = models.CharField(
        max_length=2048,
        blank=True,
        null=True,
    ...
    realization_format = models.CharField(
    ...
    structural_unit_implementer = models.ForeignKey(
        "StructuralUnit",
        on_delete=models.SET_NULL,
        blank=True,
        null=True,
    ...
    ep_supervisor = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
        verbose_name="руководитель ОП",
        related_name="director_of_megafaculty_in_gh",
        blank=True,
        null=True,
    )
    directors_position = models.CharField(
        max_length=512, verbose_name="должность руководителя ОП", blank=True, null=True
    )
    dean_of_the_faculty = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
        verbose_name="Декан факультета",
        related_name="dean_of_the_faculty_in_gh",
        blank=True,
        null=True,
    )
    dean_of_the_faculty_directors_position = models.CharField(
        max_length=512, verbose_name="должность Декана", blank=True, null=True
    )
    cluster_name = models.CharField(
        max_length=512,
        verbose_name="Имя подразделения, кластера, института",
        blank=True,
        null=True,
    )
    science_type = models.BooleanField(
        blank=True, null=True, verbose_name="Научная ОП?"
    )
    industrial_type = models.BooleanField(
        blank=True, null=True, verbose_name="Индустриальная ОП?"
    )
    corporate_type = models.BooleanField(
        blank=True, null=True, verbose_name="Корпоративная ОП?"
    )
    enterprise_type = models.BooleanField(
        blank=True, null=True, verbose_name="Предпринемательская ОП?"
    )
    target_master_type = models.BooleanField(
        blank=True, null=True, verbose_name="Магистратура перспективных направлений?"
    )
    on_check = models.CharField(
        max_length=1024,
        verbose_name="Статус проверки",
...
class Department(models.Model):
    ...
    mini_titile = models.CharField(
        max_length=512,
        verbose_name="Краткое название факультета",
        blank=True,
        null=True,
    )
    ...
    service_id = models.IntegerField(
        verbose_name="id в апи-сервисе", blank=True, null=True
    )
    title_service = models.CharField(
        max_length=512,
        verbose_name="Название факультета из сервиса расписаний",
        blank=True,
        null=True,
    )
    activity_type = models.CharField(
        max_length=512, verbose_name="тип деятельности", blank=True, null=True
    )
    version = models.IntegerField(
        verbose_name="Версия обновления", blank=True, null=True
    )
...
class GeneralizedLaborFunctions(models.Model):
    ...
    code = models.CharField(
        max_length=512,
        verbose_name="Код обощенной трудовой функции",
        blank=True,
        null=True,
    )
    name = models.CharField(
        max_length=512,
        verbose_name="обобщенные трудовые функции",
        blank=True,
        null=True,
    )
    qualification_level = models.CharField(
        choices=qualification_choice,
        max_length=512,
        verbose_name="обобщенные трудовые функции",
        blank=True,
        null=True,
    )
    professional_standard = models.ForeignKey(
        "ProfessionalStandard",
        on_delete=models.CASCADE,
        verbose_name="Профессиональный стандарт",
        blank=True,
        null=True,
        related_name="generalized_labor_functions",
    )
...
class ProfessionalStandard(models.Model):
    ...
    title = models.CharField(
        max_length=512,
        verbose_name="Наименование профессионального стандарта из данной области",
    )
    code = models.CharField(
        max_length=512,
        verbose_name="Код профессионального стандарта из данной области",
        blank=True,
        null=True,
    )
    name_of_prof_area = models.CharField(
        max_length=512,
        verbose_name="Наименование  области проф. деятельности",
        blank=True,
        null=True,
    )
    code_of_prof_area = models.CharField(
        max_length=512,
        verbose_name="Код обощенной трудовой функции",
        blank=True,
        null=True,
    ...
    registration_number = models.IntegerField(
        verbose_name="Регистрационный номер", blank=True, null=True
    )
...
class ImplementationAcademicPlan(models.Model):
    ...
    op_isu_id = models.PositiveIntegerField(
        verbose_name="ID ОП в ИСУ", blank=True, null=True
    )
    ns_id = models.PositiveIntegerField(
        verbose_name="ID учебного плана в ИСУ", blank=True, null=True
    )
    ap_isu_id = models.PositiveIntegerField(
        verbose_name="ID учебного плана в ИСУ", blank=True, null=True
    ...
    title = models.CharField(
        max_length=1024, verbose_name="Название", blank=True, null=True
    )
    ...
    editors = models.ManyToManyField(
        ...
        verbose_name="Редакторы образовательной программы",
        blank=True,
    )

    # Новые поля из ИСУ (по логике могут конфликтовать с нашей базой)
    plan_type = models.CharField(
        max_length=1024, choices=types_of_plan, verbose_name="Тип плана", default="base"
    )
    training_period = models.IntegerField(
        default=0, verbose_name="Срок обучения в годах"
    )
    structural_unit = models.ForeignKey(
        "StructuralUnit",
        on_delete=models.SET_NULL,
        verbose_name="Структурное подразделение",
        related_name="implementation_academic_plan_in_structural_unit",
        blank=True,
        null=True,
    )
    total_intensity = models.IntegerField(
        default=0, verbose_name="Количество зачетных единиц"
    )
    military_department = models.BooleanField(
        verbose_name="Наличие военной кафедры", default=False
    )
    university_partner = models.ManyToManyField(
        "UniversityPartner",
        verbose_name="ВУЗ партнер",
        related_name="implementation_academic_plan_in_university_partner",
        blank=True,
    )
    isu_modified_plan = models.JSONField(
        blank=True,
        null=True,
        verbose_name="JSON УП из ИСУ с модифицированным ID модулей",
    )

    def __str__(self):
        return (
            "НАШ ОП ид: " + str(self.id) + " / " + "ОП ИСУ ИД: " + str(self.op_isu_id)
        )
    ...
    def get_all_imp_by_modules(modules):
        ...
        for module in modules:
            ...
            if fathers:
                imp_list = imp_list | ImplementationAcademicPlan.get_all_imp_by_modules(
                    fathers
                )
            else:
...
class DisciplineBlock(CloneMixin, models.Model):
    ...
    academic_plan = models.ForeignKey(
        ...
        related_name="discipline_blocks_in_academic_plan",
        blank=True,
        null=True,
    )
...
class DisciplineBlockModule(CloneMixin, models.Model):
    ...
    TYPES = [
        ...
        (
            "digital_culture_in_professional_activities",
    ...
    selection_parametr = models.CharField(
        max_length=100, verbose_name="Параметр выбора модуля", blank=True, null=True
    )
    description = models.CharField(
        max_length=10240,
        verbose_name="Описания блока модуля дисциплин",
        blank=True,
        null=True,
    )
    editors = models.ManyToManyField(
        settings.AUTH_USER_MODEL,
        related_name="discipline_block_modules",
        verbose_name="Редакторы образовательных модулей",
        blank=True,
    )
    module_isu_id = models.IntegerField(
        blank=True, null=True, verbose_name="ID модуля в ИСУ"
    )
    childs = models.ManyToManyField(
        "self", related_name="father_module", blank=True, symmetrical=False
    )
    # father = models.ForeignKey('self', on_delete=models.SET_NULL, related_name="inheritage_module",blank=True, null=True)
    educational_programs_to_access = models.ManyToManyField(
        "ImplementationAcademicPlan",
        verbose_name="Разрешенные образовательные программы",
        related_name="modules_to_access",
        blank=True,
    )

    only_for_struct_units = models.BooleanField(
        verbose_name="Доавбление только для тех же структрных подразеделений",
        blank=True,
        null=True,
        default=False,
    )

    orderings_for_ups = models.JSONField(
        blank=True, null=True, verbose_name="Данные для сортировки в учебных планах"
    )
    orderings_for_modules = models.JSONField(
        blank=True, null=True, verbose_name="Данные для сортировки в модулях"
    )

    isu_ids_by_fathers = models.JSONField(
    ...
    def clone_module(module_id):
        ...
        wp_in_module = WorkProgramChangeInDisciplineBlockModule.objects.filter(
            discipline_block_module=module
        )
        for change in wp_in_module:
            clone_change = change.make_clone(
                attrs={"discipline_block_module": clone_module}
            )
            wp_in_fos = WorkProgramInFieldOfStudy.objects.filter(
    ...
    def get_structural_units(self) -> set:
        ...
        for editor in self.editors.all():
            for unit in StructuralUnit.objects.filter(
                user_in_structural_unit__user=editor
            ):
    ...
    def get_all_changeblocks_from_module(module):
        ...
        if module.childs.exists():
            for child in module.childs.all():
                changeblocks_in_module = (
                    DisciplineBlockModule.get_all_changeblocks_from_module(child)
                    | changeblocks_in_module
                )
        else:
            return (
        ...
        if new_ordinal_number == -1:
            for module in modules:
                for ap_index in module.orderings_for_ups:
                    if (
                        ap_index["up_id"] == block.academic_plan.id
                        and ap_index["number"] > old_ordinal_number
                    ):
            ...
            for module in modules:
                for ap_index in module.orderings_for_ups:
                    print(ap_index)
                    if (
                        int(ap_index["up_id"]) == block.academic_plan.id
                        and int(ap_index["number"]) == old_ordinal_number
                    ):
                        ap_index["number"] = new_ordinal_number
                    elif (
                        int(ap_index["up_id"]) == block.academic_plan.id
                        and new_ordinal_number
                        <= int(ap_index["number"])
                        <= old_ordinal_number
                    ):
...
class WorkProgramChangeInDisciplineBlockModule(CloneMixin, models.Model):
    ...
    semester_duration = models.IntegerField(
        verbose_name="Сколько семестров длится", blank=True, null=True
    )
    ...
    discipline_block_module = models.ForeignKey(
        ...
        related_name="change_blocks_of_work_programs_in_modules",
        blank=True,
        null=True,
    )
    ...
    gia = models.ManyToManyField(
        "gia_practice_app.GIA",
        verbose_name="Гиа",
        related_name="gia_in_change_block",
        through="GiaInFieldOfStudy",
        blank=True,
    )
    practice = models.ManyToManyField(
        "gia_practice_app.Practice",
    ...
    subject_code = models.CharField(
        max_length=1024, verbose_name="Срок сдачи в неделях", blank=True, null=True
    )
...
class WorkProgramInFieldOfStudy(CloneMixin, models.Model):
    ...
    work_program = models.ForeignKey(
        "WorkProgram", on_delete=models.CASCADE, related_name="zuns_for_wp"
    )
    id_str_up = models.IntegerField(
        verbose_name="Id строки учебного плана", blank=True, null=True
    )

    backup_module = models.ForeignKey(
        "DisciplineBlockModule",
        on_delete=models.CASCADE,
        related_name="module_backup",
        blank=True,
        null=True,
    )
    backup_ap = models.ForeignKey(
        "AcademicPlan",
        on_delete=models.CASCADE,
        related_name="ap_backup",
        blank=True,
        null=True,
    )
    backup_date = models.DateTimeField(
        null=True, blank=True, verbose_name="Дата бэкапа"
    )
...
class GiaInFieldOfStudy(models.Model):
    ...
    gia = models.ForeignKey(
        "gia_practice_app.GIA", on_delete=models.CASCADE, related_name="zuns_for_gia"
    )
    id_str_up = models.IntegerField(
        verbose_name="Id строки учебного плана", blank=True, null=True
    )
...
class PracticeInFieldOfStudy(models.Model):
    ...
    backup_module = models.ForeignKey(
        "DisciplineBlockModule",
        on_delete=models.CASCADE,
        related_name="module_backup_practice",
        blank=True,
        null=True,
    )
    backup_ap = models.ForeignKey(
        "AcademicPlan",
        on_delete=models.CASCADE,
        related_name="ap_backup_practice",
        blank=True,
        null=True,
    )
    backup_date = models.DateTimeField(
...
class WorkProgramIdStrUpForIsu(CloneMixin, models.Model):
    ...
    dis_id = models.IntegerField(
        verbose_name="Id дисциплины в ису", blank=True, null=True
    )
    work_program_in_field_of_study = models.ForeignKey(
...
class Zun(models.Model):
    ...
    indicator_in_zun = models.ForeignKey(
        "Indicator", on_delete=models.CASCADE, blank=True, null=True, related_name="zun"
    )
    ...
    items = models.ManyToManyField(
        ...
        verbose_name="Учебная сущность и уровень освоения",
        blank=True,
        related_name="item_in_wp",
    )
    wp_in_fs_saved_fk_id_str_up = models.IntegerField(
        verbose_name="Id строки учебного плана", blank=True, null=True
    )
...
class AcademicPlanUpdateConfiguration(models.Model):
    ...
    updates_enabled = models.BooleanField(
        verbose_name="Обновления включены", blank=False, null=False
    )
    over_23 = models.BooleanField(
        verbose_name="Новый план", blank=False, null=False, default=False
    )
...
class AcademicPlanUpdateSchedulerConfiguration(models.Model):
    days_interval = models.PositiveIntegerField(
        verbose_name="Интервал обновления в днях", blank=True, null=True
    )
    execution_hours = models.PositiveIntegerField(
        blank=True, null=True, verbose_name="Время запуска обновления"
    )
    ...
    def __str__(self):
        return (
            str(self.updated_timestamp)
            + " "
            + str(self.execution_hours)
            + " "
            + str(self.days_interval)
        )


class AcademicPlanUpdateLog(models.Model):
    academic_plan_id = models.PositiveIntegerField(
        verbose_name="ID учебного плана в ИСУ", blank=False, null=False
    )
    object_type = models.PositiveIntegerField(
        verbose_name="Измененный объект", blank=False, null=False
    )
    field_name = models.CharField(
        max_length=1024, verbose_name="Измененное поле", blank=False, null=False
    )
    old_value = models.CharField(
        max_length=1024, verbose_name="Старое значение", blank=True, null=True
    )
    new_value = models.CharField(
        max_length=1024, verbose_name="Новое значение", blank=True, null=True
    )
    updated_date_time = models.DateTimeField(
        editable=True, blank=False, null=False, verbose_name="Дата обновления"
    )
...
class CompetenceComments(models.Model):
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
        related_name="user_competence_comment",
    )
    competence = models.ForeignKey(
        "Competence", on_delete=models.CASCADE, related_name="competence_comment"
    )
    comment_text = models.CharField(max_length=50000, verbose_name="Комментарий")
    comment_date = models.DateTimeField(
        auto_now_add=True, blank=True, verbose_name="Дата комментария"
    )
...
class Indicator(models.Model):
    ...
    competence = models.ForeignKey(
        "Competence", on_delete=models.CASCADE, related_name="indicator_in_competencse"
    )
...
class EvaluationTool(CloneMixin, models.Model):
    ...
    name = models.CharField(
        max_length=1024, verbose_name="Наименование оценочного средства"
    )
    description = models.CharField(
        max_length=5000000, verbose_name="Описание", blank=True, null=True
    )
    check_point = models.BooleanField(
        verbose_name="Контрольная точка", blank=True, null=True
    )
    deadline = models.IntegerField(
        verbose_name="Срок сдачи в неделях", blank=True, null=True
    )
    semester = models.IntegerField(
        verbose_name="Семестр в котором сдается оценочное средство",
        blank=True,
        null=True,
    )
    min = models.IntegerField(
        verbose_name="Максимальное значение", blank=True, null=True
    )
    max = models.IntegerField(
        verbose_name="Минимальное значение", blank=True, null=True
    )
    evaluation_criteria = models.CharField(
        max_length=2048, verbose_name="Критерии оценивания", blank=True, null=True
    )
...
class CertificationEvaluationTool(CloneMixin, models.Model):
    ...
    name = models.CharField(
        ...
        null=True,
        max_length=1024,
        verbose_name="Наименование оценочного средства",
        default="No name",
    )
    description = models.CharField(
        max_length=500000, verbose_name="Описание", blank=True, null=True
    )
...
class DisciplineSection(CloneMixin, models.Model):
    ...
    evaluation_tools = models.ManyToManyField(
        "EvaluationTool",
    ...
    contact_work = models.DecimalField(
        verbose_name="Контактная работа",
        max_digits=5,
        decimal_places=2,
        blank=True,
        null=True,
    )
    lecture_classes = models.DecimalField(
        verbose_name="Занятия лекционного типа",
        max_digits=5,
        decimal_places=2,
        blank=True,
        null=True,
    ...
    laboratory = models.DecimalField(
        verbose_name="Лабораторные занятия",
        max_digits=5,
        decimal_places=2,
        blank=True,
        null=True,
    )
    practical_lessons = models.DecimalField(
        verbose_name="Практические занятия",
        max_digits=5,
        decimal_places=2,
        blank=True,
        null=True,
    ...
    SRO = models.DecimalField(
        verbose_name="СРО", max_digits=5, decimal_places=2, blank=True, null=True
    )
    ...
    def new_ordinal_number(descipline_section, new_ordinal_number):
        ...
        if new_ordinal_number == -1:
            sections = DisciplineSection.objects.filter(
                work_program=section.work_program
            ...
            section.save()
            sections = (
                DisciplineSection.objects.filter(
                    work_program=section.work_program,
                    ordinal_number__gte=new_ordinal_number,
                )
                .exclude(pk=descipline_section)
                .order_by("ordinal_number")
            )
            for sec in sections:
            ...
            sections = (
                DisciplineSection.objects.filter(
                    work_program=section.work_program,
                    ordinal_number__lte=new_ordinal_number,
                )
                .exclude(pk=descipline_section)
                .order_by("ordinal_number")
            )
...
class BibliographicReference(models.Model):
    ...
    authors = models.CharField(
        max_length=4096, verbose_name="Авторы", blank=True, null=True
    )
    main_author = models.CharField(
        max_length=1024, verbose_name="Главный автор", blank=True, null=True
    )
    publication_type = models.CharField(
        max_length=1024, verbose_name="Тип публикации", blank=True, null=True
    )
    title = models.CharField(
        max_length=4096, verbose_name="Наименование", blank=True, null=True
    )
    publishing_company = models.CharField(
        max_length=1024, verbose_name="Издатель", blank=True, null=True
    )
    year = models.CharField(
        max_length=512, verbose_name="Год издания", blank=True, null=True
    )
    number_of_edition = models.PositiveIntegerField(
        verbose_name="Номер издания", blank=True, null=True
    )
    pages = models.PositiveIntegerField(
        verbose_name="Количество страниц", blank=True, null=True
    )
    # Если получится понять что это, то возможно чузфилд
    format = models.CharField(
        max_length=512, verbose_name="Формат", blank=True, null=True
    )
    # Возможно тоже чузфилд, пока это захардкожено
    publishing_type = models.CharField(
        max_length=1024, verbose_name="Тип публикации", blank=True, null=True
    )
    bib_reference = models.CharField(
        max_length=4096, verbose_name="Библиогарфическая ссылка", blank=True, null=True
    )
    description = models.CharField(
        max_length=5000, verbose_name="Описание", blank=True, null=True
    )
    from_lan = models.BooleanField(
        verbose_name="Добавлено из ЭБС Лань", blank=True, null=True
    )
...
class Topic(CloneMixin, models.Model):
    ...
    url_online_course = models.ForeignKey(
        OnlineCourse,
        on_delete=models.CASCADE,
        verbose_name="Онлайн курс",
        blank=True,
        null=True,
        related_name="topic_with_online_course",
    )
    ...
    def new_ordinal_number(topic, new_ordinal_number):
        ...
        if new_ordinal_number == -1:
            sections = Topic.objects.filter(
                discipline_section=section.discipline_section
            ).order_by("number")
            for sec in sections:
            ...
            sections = (
                Topic.objects.filter(
                    discipline_section=section.discipline_section,
                    number__gte=new_ordinal_number,
                )
                .exclude(pk=topic)
                .order_by("number")
            )
            ...
            sections = (
                Topic.objects.filter(
                    discipline_section=section.discipline_section,
                    number__lte=new_ordinal_number,
                )
                .exclude(pk=topic)
                .order_by("number")
            )
...
class Certification(models.Model):
    ...
    work_program = models.ForeignKey(
        "WorkProgram", on_delete=models.CASCADE, related_name="discipline_certification"
    )
...
class Profession(models.Model):
    ...
    title = models.CharField(
        max_length=1024, blank=True, null=True, verbose_name="Название профессии"
    )
    skills = models.ManyToManyField(
        Items,
        related_name="profession_skils",
        through="SkillsOfProfession",
        blank=True,
        verbose_name="Навыки",
    )
...
class Role(models.Model):
    ...
    skills = models.ManyToManyField(
        Items,
        related_name="role_skils",
        through="SkillsOfRole",
        blank=True,
        verbose_name="Навыки",
    )
...
class SkillsOfProfession(models.Model):
    ...
    item = models.ForeignKey(
        ...
        related_name="item_in_sop",
    )
    profession = models.ForeignKey(
        Profession, on_delete=models.CASCADE, verbose_name="Рабочая программа"
    )
    MasterylevelChoices = [
        ("1", "low"),
        ("2", "average"),
...
class SkillsOfRole(models.Model):
    ...
    item = models.ForeignKey(
        ...
        on_delete=models.CASCADE,
        verbose_name="Пререквизит",
        related_name="item_in_sor",
    )
    role = models.ForeignKey(
        Role, on_delete=models.CASCADE, verbose_name="Рабочая программа"
    )
    MasterylevelChoices = [
        ("1", "low"),
        ("2", "average"),
...
class DisciplineBlockModuleInIsu(models.Model):
    module = models.ForeignKey(
        DisciplineBlockModule, on_delete=models.CASCADE, related_name="isu_module"
    )
    isu_id = models.IntegerField(verbose_name="ИСУ ид модуля")
    isu_father_id = models.IntegerField(
        verbose_name="ИСУ ид родителя", blank=True, null=True
    )
    academic_plan = models.ForeignKey(
        AcademicPlan,
        on_delete=models.CASCADE,
        related_name="module_isu_in_plan",
        blank=True,
        null=True,
    )
    new_id = models.CharField(
        max_length=1024, blank=True, null=True, verbose_name="ap_id and isu_module_id"
    )
...
class IsuObjectsSendLogger(models.Model):
    ...
    obj_type = models.CharField(
        max_length=50, choices=ObjTypeChoices, default=1, verbose_name="Тип объекта"
    )
...
class IsuModulesHashes(models.Model):
    ...
    new_id = models.CharField(
        max_length=1024, blank=True, null=True, verbose_name="ap_id+isu_module_id"
    )
...
class BugsLog(models.Model):
    ...
    file = models.FileField(
        upload_to=get_upload_path_for_bugs_log, null=True, blank=True
    )
    user = models.ForeignKey(
