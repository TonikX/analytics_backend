...
class GeneralCharacteristics(models.Model):
    ...
    area_of_activity = models.ManyToManyField('ProfessionalStandard',
                                              ...
                                              blank=True, null=True)
    objects_of_activity = models.CharField(max_length=4096, verbose_name="Объекты профессиональной деятельности",
                                           blank=True, null=True)
...
class WorkProgramInFieldOfStudy(CloneMixin, models.Model):
    ...
    def __str__(self):
        return (str(self.work_program_change_in_discipline_block_module) + str(self.work_program) + str(self.id_str_up))
