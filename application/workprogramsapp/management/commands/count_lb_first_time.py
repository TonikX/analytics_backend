...
from workprogramsapp.models import DisciplineBlockModule, DisciplineBlockModuleInIsu, WorkProgram
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        modules_for_count = DisciplineBlockModule.objects.filter(
            descipline_block__academic_plan__academic_plan_in_field_of_study__year__gte=2023).distinct()
