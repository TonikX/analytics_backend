...
from workprogramsapp.models import Indicator, GeneralCharacteristics, WorkProgram
    ...
    def handle(self, *args, **options):
        ...
        for zun_id in data:
            ...
            for gh in gh_list:
                ...
                work_profram_from_zun = WorkProgram.objects.get(
                    zuns_for_wp__zun_in_wp=zun_id
                )
                for plan in plans:
