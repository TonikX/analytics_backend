...
class GIABaseTemplateSerializer(serializers.ModelSerializer):
    def to_representation(self, value):
        self.fields["professional_problems_marks"] = CriteriaVKRSerializer(
            required=False
        )
...
class GIASerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, value):
        ...
        self.fields["content_correspondence_marks"] = CriteriaVKRSerializer(
            required=False
        )
        self.fields["relevance_marks"] = CriteriaVKRSerializer(required=False)
        self.fields["specialization_correspondence_marks"] = CriteriaVKRSerializer(
            required=False
        )
        self.fields["correctness_of_methods_marks"] = CriteriaVKRSerializer(
            required=False
        )
        ...
        self.fields["presentation_quality_marks"] = CriteriaVKRSerializer(
            required=False
        )
        ...
        self.fields["gia_in_change_block"] = (
            WorkProgramChangeInDisciplineBlockModuleForWPinFSSerializer(many=True)
        )
        self.fields["expertise_with_gia"] = ShortExpertiseSerializer(
            many=True,
        )
