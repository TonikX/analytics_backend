...
class Practice(models.Model):
    ...
    types = (
        ...
        (
            "ind-tech",
            "технологическая (проектно-технологическая) / Industrial and tech Internship",
        ),
        (
            "teh-proj-tech-intet",
            "технологическая (проектно-технологическая)/ Tech Project Internship",
        ),
    ...
    editors = models.ManyToManyField(
        ...
        related_name="editors_practice",
        verbose_name="Редакторы РПД",
        blank=True,
    )

    practice_base = models.ForeignKey(
        "PracticeTemplate",
        on_delete=models.SET_NULL,
        verbose_name="Базовый шаблон Практики",
        related_name="practice_heir",
        blank=True,
        null=True,
    )
    ...
    structural_unit = models.ForeignKey(
        ...
        related_name="practice_in_structural_unit",
        blank=True,
        null=True,
    )
    ...
    kind_of_practice = models.CharField(
        choices=kinds, max_length=64, verbose_name="Вид практики", blank=True, null=True
    )
    type_of_practice = models.CharField(
        choices=types, max_length=64, verbose_name="Тип практики", blank=True, null=True
    )
    way_of_doing_practice = models.CharField(
        choices=ways,
        max_length=64,
        verbose_name="Способ прохождения практики",
        blank=True,
        null=True,
    )
    format_practice = models.CharField(
        choices=formats,
        max_length=64,
        verbose_name="Формат прохождения практики",
        blank=True,
        null=True,
    )

    features_content_and_internship = models.TextField(
        max_length=4096,
        verbose_name="Особенности содержания и прохождения практики",
        blank=True,
        null=True,
    )
    features_internship = models.TextField(
        max_length=4096,
        verbose_name="Особенности содержания практики",
        blank=True,
        null=True,
    )
    additional_reporting_materials = models.TextField(
        max_length=4096,
    ...
    form_of_certification_tools = models.CharField(
    ...
    bibliographic_reference = models.ManyToManyField(
        "workprogramsapp.BibliographicReference",
        blank=True,
    ...
    prerequisites = models.ManyToManyField(
        ...
        related_name="practice_prerequisites",
        through="PrerequisitesOfPractice",
        blank=True,
    ...
    prac_isu_id = models.IntegerField(
        blank=True, null=True, verbose_name="ID практики в ИСУ"
    )
    ...
    evaluation_tools_v_sem = models.CharField(
        max_length=1024,
        blank=True,
        null=True,
    ...
    number_of_semesters = models.IntegerField(
        blank=True, null=True, verbose_name="Количество семестров в практике"
    )
...
class PrerequisitesOfPractice(models.Model):
    ...
    practice = models.ForeignKey(
        Practice, on_delete=models.CASCADE, verbose_name="Рабочая программа"
    )
    MasterylevelChoices = [
        ("1", "low"),
        ("2", "average"),
