  ...
  <Router>
    <Layout>
      <Switch>
        ...
        <AuthRoute
          path={routerService.getTrajectoryPlanDetailRoute()}
          children={() => (
            <Route
              render={({ match }) => (
        ...
        <AuthRoute
          path={routerService.getProfessionSkillsRoute()}
          children={() => (
            <Route render={({ match }) => <ProfessionSkills match={match} />} />
          )}
        />
        ...
        <AuthRoute
          path={routerService.getRolesSkillsRoute()}
          children={() => (
            <Route render={({ match }) => <RolesSkills match={match} />} />
          )}
        />
        ...
        <AuthRoute
          path={routerService.getEducationPlanDetailRoute()}
          children={() => (
            <Route
              render={({ match }) => <EducationPlanDetail match={match} />}
            />
          )}
        />
        ...
        <AuthRoute
          path={routerService.getWorkProgramRoute()}
          children={() => (
            <Route render={({ match }) => <WorkProgram match={match} />} />
          )}
        />
