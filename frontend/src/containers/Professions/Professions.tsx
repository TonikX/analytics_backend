...
class Professions extends React.Component<ProfessionsProps> {
    ...
    handleSelectFilter = (items: Array<any>) => {
        this.props.actions.changeFilteredRole(get(items, 0, ''));
        this.changeFilter();
    }
                ...
                <div className={classes.tableWrap}>
                    <div className={classNames(classes.listItem, classes.header)}>
                        ...
                        <Typography className={classNames(classes.marginRight, classes.roleCell)}>
                            Роль
                            <SortingButton changeMode={this.changeSorting(ProfessionsFields.ROLE)}
                                           mode={sortingField === ProfessionsFields.ROLE ? sortingMode : ''}
                            />
                            <TableFilter items={roles} handleSelect={this.handleSelectFilter} />
                        </Typography>
                    </div>
                        ...
                        <Scrollbars>
                            {professionsList.map(item =>
                                <div className={classes.listItem} key={item[ProfessionsFields.ID]}>
                                    ...
                                    <Typography className={classNames(classes.marginRight, classes.roleCell)}>
                                        {get(roles, item[ProfessionsFields.ROLE])}
                                    </Typography>
