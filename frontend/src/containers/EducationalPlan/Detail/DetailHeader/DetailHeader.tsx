  ...
  const validationErrors = getValidationErrors()
    ...
    return (
      ...
      <Typography className={classes.noteText}>
        Если Вы включили модуль, который использовался в учебных планах 2018-2023 года, в учебный план 2024 года набора, возможны коллизии в данных, т.к. если этот план обновится в одному году, он обновится и для планов других годов набора. <b>Рекомендуем делать разные модули для разных годов набора.</b>
      </Typography>
