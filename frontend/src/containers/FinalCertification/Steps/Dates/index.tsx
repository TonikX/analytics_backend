    ...
    render() {
        ...
        return (
            <div className={classes.content}>
                ...
                <Input label='Заполнение и согласование задания на ВКР в ИСУ' fieldName={CertificationFields.FILLING_AND_APPROVAL_TIME}/>
                ...
                <Input label='Проверка текста ВКР в системе “Антиплагиат”' fieldName={CertificationFields.ANTI_PLAGIARISM_ANALYSIS_TIME}/>
            </div>
        );
    }
}
