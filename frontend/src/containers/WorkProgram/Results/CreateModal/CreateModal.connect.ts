...
import {getEvaluationToolsForSelect, isOpenDialog, getDialogData} from '../../getters';
...
const mapStateToProps = (state: rootState) => {
    return {
        ...
        evaluationTools: getEvaluationToolsForSelect(state),
        isOpen: isOpenDialog(state, fields.ADD_NEW_RESULT),
        result: getDialogData(state, fields.ADD_NEW_RESULT),
    };
};
