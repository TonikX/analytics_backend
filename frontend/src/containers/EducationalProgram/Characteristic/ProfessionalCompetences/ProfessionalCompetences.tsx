                    ...
                    <TableCell className={classes.standardCell}>
                      {competenceItem.professional_standard ?
                        <>
                          ...
                          {canEdit ? <Tooltip title="Удалить профессиональный стандарт" onClick={deleteProfessionalStandard(competenceItem.id)}>
                            <DeleteIcon className={classes.deleteIcon}/>
                          </Tooltip> : null}
                        </>
                        :
                      ...
                      <>
                        {competenceItem.generalized_labor_functions?.map((item: any) => (
                          <div style={{ display: 'flex', alignItems: "center" }}>
                            {item?.code} {item?.name}
                            {canEdit ? <Tooltip title="Удалить трудовую функцию"
